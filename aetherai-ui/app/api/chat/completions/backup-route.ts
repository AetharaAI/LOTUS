...
export async function POST(req: NextRequest) {
  try {
    ...
    if (clientModel === 'qwen3-vl-local') {
      upstreamUrl = process.env.AETHER_UPSTREAM_URL || 'http://localhost:8001/v1/chat/completions';
      apiKey = process.env.AETHER_API_KEY || 'sk-aether-sovereign-master-key-2026';
